    ...
    return (
        <div className="home-page">
            ...
            >
                {/* First Slide */}
                <div>
                    <img className='carouselImg' src={`${process.env.PUBLIC_URL}/img/carousel.png`} alt="Slide 1" />
                    <div className="legend">
                        <h1 className='homeSlogan'>Ngày trôi, việc chảy!</h1>
                        <p>Không gian tích hợp đa dạng dịch vụ giúp thúc đẩy công việc của bạn phát triển một cách tối đa.</p>
                ...
                {/* Second Slide */}
                <div>
                    <img className='carouselImg' src={`${process.env.PUBLIC_URL}/img/carousel.png`} alt="Slide 2" />
                    <div className="legend">
                        <h1 className='homeSlogan'>Ngày trôi, việc chảy!</h1>
                        <p>Không gian tích hợp đa dạng dịch vụ giúp thúc đẩy công việc của bạn phát triển một cách tối đa.</p>
                        <button className="cta-button" onClick={handleBookNow}>BOOK NOW</button>
                ...
                {/* Third Slide */}
                <div>
                    <img className='carouselImg' src={`${process.env.PUBLIC_URL}/img/carousel.png`} alt="Slide 3" />
                    <div className="legend">
                        <h1 className='homeSlogan'>Ngày trôi, việc chảy!</h1>
                        <p>Không gian tích hợp đa dạng dịch vụ giúp thúc đẩy công việc của bạn phát triển một cách tối đa.</p>
                        <button className="cta-button" onClick={handleBookNow}>BOOK NOW</button>
